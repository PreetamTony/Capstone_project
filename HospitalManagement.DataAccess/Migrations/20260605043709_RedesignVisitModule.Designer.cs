...
namespace HospitalManagement.DataAccess.Migrations
{
    ...
    [Migration("20260605043709_RedesignVisitModule")]
    partial class RedesignVisitModule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HospitalManagement.DataAccess.Models.Visit", b =>
                {
                    ...
                    b.HasOne("HospitalManagement.DataAccess.Models.Billing", "Billing")
                        .WithMany()
                        .HasForeignKey("BillingId1");

                    b.HasOne("HospitalManagement.DataAccess.Models.Consultation", "Consultation")
                        .WithOne("Visit")
                        .HasForeignKey("HospitalManagement.DataAccess.Models.Visit", "ConsultationId")
                        .OnDelete(DeleteBehavior.Restrict);
